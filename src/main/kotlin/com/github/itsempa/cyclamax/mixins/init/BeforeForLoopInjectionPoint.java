package com.github.itsempa.cyclamax.mixins.init;
...
/**
 * * Taken from SkyHanni
 * * <a href="https://github.com/hannibal002/SkyHanni/blob/beta/src/main/java/at/hannibal2/skyhanni/mixins/init/BeforeForLoopInjectionPoint.java">Source</a>
 ...
 *
 * <pre>{@code
 * @Inject(method = "...", at = @At(value = "CYCLAMAX_FORLOOP_LOCAL_VAR", args = "lvIndex=1"))
 * }</pre>
 */
@InjectionPoint.AtCode("CYCLAMAX_FORLOOP_LOCAL_VAR")
