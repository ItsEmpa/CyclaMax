package com.github.itsempa.cyclamax.modules
...
class ModuleProcessor(
    ...
    private val CLASS_NAME = "CyclaMaxModules"
    private val PACKAGE = "com.github.itsempa.cyclamax.modules"
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        logger.warn("Generating $CLASS_NAME.kt")

        val file = FileSpec.builder(PACKAGE, CLASS_NAME)
            .indent("    ")
            .addType(
                TypeSpec.objectBuilder("CyclaMaxModules").apply {
                    this.addProperty(
        ...
        logger.warn("Generated $CLASS_NAME.kt")
